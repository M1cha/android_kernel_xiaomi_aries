...
static struct lm3554_platform_data lm3554_led_flash = {
        ...
        .gpio_reg_def = 0x0,
        .hwen_gpio = PM8921_GPIO_PM_TO_SYS(30),
        .strobe_gpio = 1,
};
...
static struct i2c_registry apq8064_i2c_camera_device[] __initdata = {
#if defined(CONFIG_LEDS_LM3554)
	{
		I2C_FFA,
...
void __init xiaomi_add_camera_devices(void)
{
	int i;

	/* Run the array and install devices as appropriate */
	for (i = 0; i < ARRAY_SIZE(apq8064_i2c_camera_device); ++i) {
		i2c_register_board_info(apq8064_i2c_camera_device[i].bus,
					apq8064_i2c_camera_device[i].info,
					apq8064_i2c_camera_device[i].len);
	}
}