 ...
 */
void __init apq8064_add_drivers(void)
{
	msm_smd_init();
	msm_rpm_driver_init();
	msm_spm_device_init();
...
void __init apq8064_init(void)
{
	 ...
	 * msm_smem_init before it.  apq8064_init_gpiomux needs socinfo so
...
DT_MACHINE_START(MSM8064_DT,
		"Qualcomm Technologies, Inc. APQ 8064 (Flattened Device Tree)")
	.map_io			= msm_map_apq8064_io,
	.init_machine		= apq8064_init,
