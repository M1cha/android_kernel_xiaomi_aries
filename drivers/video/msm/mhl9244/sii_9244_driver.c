...
// GaryYuan's addition for MHL status and MHL INT
...
static void WriteInitialRegisterValues ( void )
{
	...
	I2C_WriteByte(PAGE_0_0X72, 0x93, 0x8C);				// Disable CBUS pull-up during RGND measurement
...
#define CBUS_LINK_STATUS_2 0x38
	...
	if(reg71)
	{
		...
		I2C_WriteByte(PAGE_0_0X72, 0x71, reg71);  /*INTR_1_DESIRED_MASK*/
	}
	//
...
bool_t SiiMhlTxChipInitialize ( void )
{
	...
	I2C_WriteByte(PAGE_0_0X72, 0x71, INTR_1_DESIRED_MASK); // [dave] clear HPD & RSEN interrupts
...
void SiiMhlTxDeviceIsr( void )
{
	...
	TX_DEBUG_PRINT(("Drv: INT1 Status = %02X\n", (int) I2C_ReadByte(PAGE_0_0X72, 0x71)));
	TX_DEBUG_PRINT(("Drv: INT2 Status = %02X\n", (int) I2C_ReadByte(PAGE_0_0X72, 0x72)));
	TX_DEBUG_PRINT(("Drv: INT3 Status = %02X\n", (int) I2C_ReadByte(PAGE_0_0X72, 0x73)));
	TX_DEBUG_PRINT(("Drv: INT4 Status = %02X\n", (int) I2C_ReadByte(PAGE_0_0X72, 0x74)));

	//TX_DEBUG_PRINT("Drv: INT5 Status = %02X\n", (int) SiiRegRead(REG_INTR5));


	TX_DEBUG_PRINT(("Drv: cbusInt Status = %02X\n", (int) I2C_ReadByte(PAGE_CBUS_0XC8, 0x08)));

	TX_DEBUG_PRINT(("Drv: CBUS INTR_2: %02X\n", (int) I2C_ReadByte(PAGE_CBUS_0XC8, 0x1E)));
	TX_DEBUG_PRINT(("Drv: A0 INT Set = %02X\n", (int) I2C_ReadByte(PAGE_CBUS_0XC8, 0xA0)));
	TX_DEBUG_PRINT(("Drv: A1 INT Set = %02X\n", (int) I2C_ReadByte(PAGE_CBUS_0XC8, 0xA1)));
	TX_DEBUG_PRINT(("Drv: A2 INT Set = %02X\n", (int) I2C_ReadByte(PAGE_CBUS_0XC8, 0xA2)));
	TX_DEBUG_PRINT(("Drv: A3 INT Set = %02X\n", (int) I2C_ReadByte(PAGE_CBUS_0XC8, 0xA3)));

	TX_DEBUG_PRINT(("Drv: B0 STATUS Set = %02X\n", (int) I2C_ReadByte(PAGE_CBUS_0XC8, 0xB0)));
	TX_DEBUG_PRINT(("Drv: B1 STATUS Set = %02X\n", (int) I2C_ReadByte(PAGE_CBUS_0XC8, 0xB1)));
	TX_DEBUG_PRINT(("Drv: B2 STATUS Set = %02X\n", (int) I2C_ReadByte(PAGE_CBUS_0XC8, 0xB2)));
	TX_DEBUG_PRINT(("Drv: B3 STATUS Set = %02X\n", (int) I2C_ReadByte(PAGE_CBUS_0XC8, 0xB3)));

	TX_DEBUG_PRINT(("Drv: E0 STATUS Set = %02X\n", (int) I2C_ReadByte(PAGE_CBUS_0XC8, 0xE0)));
	TX_DEBUG_PRINT(("Drv: E1 STATUS Set = %02X\n", (int) I2C_ReadByte(PAGE_CBUS_0XC8, 0xE1)));
	TX_DEBUG_PRINT(("Drv: E2 STATUS Set = %02X\n", (int) I2C_ReadByte(PAGE_CBUS_0XC8, 0xE2)));
	TX_DEBUG_PRINT(("Drv: E3 STATUS Set = %02X\n", (int) I2C_ReadByte(PAGE_CBUS_0XC8, 0xE3)));

	TX_DEBUG_PRINT(("Drv: F0 INT Set = %02X\n", (int) I2C_ReadByte(PAGE_CBUS_0XC8, 0xF0)));
	TX_DEBUG_PRINT(("Drv: F1 INT Set = %02X\n", (int) I2C_ReadByte(PAGE_CBUS_0XC8, 0xF1)));
	TX_DEBUG_PRINT(("Drv: F2 INT Set = %02X\n", (int) I2C_ReadByte(PAGE_CBUS_0XC8, 0xF2)));
	TX_DEBUG_PRINT(("Drv: F3 INT Set = %02X\n", (int) I2C_ReadByte(PAGE_CBUS_0XC8, 0xF3)));
	...
	else if( POWER_STATE_D0_MHL == fwPowerState )
	{
		while ((I2C_ReadByte(PAGE_0_0X72, 0x09) & BIT2) == 0x00 &&
				(!HalTimerExpired( TIMER_TO_DO_RSEN_CHK )))// when plug out the MHL dongle in 400ms TIMER_TO_DO_RSEN_CHK timer
		{
