...
static struct mipi_dsi_phy_ctrl dsi_cmd_mode_phy_db = {
	...
	/* timing   */
	.timing = {0x66, 0x26, 0x19, /* panel specific */
		0x00, /* DSIPHY_TIMING_CTRL_3 = 0 */
		0x1C, 0x91, 0x1E, 0x8D, 0x1C, 0x3, 0x4}, /* panel specific */
	/* pll control */
	.pll = {0x00, /* common 8960 */
	/* VCO */
	0x4A, 0x01, 0x1A, /* panel specific */
	0x00, 0x50, 0x48, 0x63, /**/
...
module_init(mipi_cmd_xiaomi_720p_pt_init);
