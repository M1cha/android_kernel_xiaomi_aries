...
static struct msm_camera_i2c_reg_conf ov2722_720_settings[] = {
	{0x3800, 0x01},
	{0x3801, 0x4a},
	{0x3802, 0x00},
	{0x3803, 0xba},
...
static struct msm_camera_i2c_reg_conf ov2722_vga_settings[] = {
	{0x3800, 0x00},
	{0x3801, 0x0c},
	{0x3802, 0x00},
	{0x3803, 0x02},
...
static struct msm_camera_i2c_reg_conf ov2722_60fps_settings[] = {
	{0x3718, 0x10},
	{0x3702, 0x18},
	{0x373a, 0x3c},
	{0x3715, 0x01},
...
static struct msm_camera_i2c_reg_conf ov2722_90fps_settings[] = {
	{0x3718, 0x10},
	{0x3702, 0x18},
	{0x373a, 0x3c},
	{0x3715, 0x01},
...
static struct msm_camera_i2c_reg_conf ov2722_120fps_settings[] = {
	{0x3718, 0x10},
	{0x3702, 0x18},
	{0x373a, 0x3c},
	{0x3715, 0x01},
...
static struct msm_camera_i2c_conf_array ov2722_confs[] = {
	...
	{&ov2722_vga_settings[0],
	ARRAY_SIZE(ov2722_vga_settings), 0, MSM_CAMERA_I2C_BYTE_DATA},
	{&ov2722_720_settings[0],
	ARRAY_SIZE(ov2722_720_settings), 0, MSM_CAMERA_I2C_BYTE_DATA},
	{&ov2722_60fps_settings[0],
	ARRAY_SIZE(ov2722_60fps_settings), 0, MSM_CAMERA_I2C_BYTE_DATA},
	{&ov2722_90fps_settings[0],
	ARRAY_SIZE(ov2722_90fps_settings), 0, MSM_CAMERA_I2C_BYTE_DATA},
	{&ov2722_120fps_settings[0],
	ARRAY_SIZE(ov2722_120fps_settings), 0, MSM_CAMERA_I2C_BYTE_DATA},
};
...
static int32_t ov2720_write_init_settings(struct msm_sensor_ctrl_t *s_ctrl)
{
	int32_t rc;
	...
	if (strcmp(s_ctrl->sensordata->sensor_name, "ov2720") == 0) {
		rc = msm_sensor_write_all_conf_array(
				s_ctrl->sensor_i2c_client,
				&ov2720_init_conf[0],
				ARRAY_SIZE(ov2720_init_conf));
	} else {
		rc = msm_sensor_write_all_conf_array(
				s_ctrl->sensor_i2c_client,
				&ov2722_init_conf[0],
				ARRAY_SIZE(ov2722_init_conf));
	}

	return rc;
}

static int32_t ov2720_write_res_settings(struct msm_sensor_ctrl_t *s_ctrl, uint16_t res)
{
	int32_t rc;
