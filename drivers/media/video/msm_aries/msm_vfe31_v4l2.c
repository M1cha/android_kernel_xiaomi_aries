...
#define VFE_MSG_V31_START VFE_MSG_START
#define VFE_MSG_V31_CAPTURE VFE_MSG_CAPTURE
#define VFE_MSG_V31_JPEG_CAPTURE VFE_MSG_JPEG_CAPTURE
#define VFE_MSG_V31_START_RECORDING VFE_MSG_START_RECORDING
